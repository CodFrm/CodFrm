...
*   [hb-chen/micro-starter](https://github.com/hb-chen/micro-starter) - Micro 微服务实践
...
*   [animefansxj/luci-app-vsftpd](https://github.com/animefansxj/luci-app-vsftpd) - vsftpd Configure page for Lua Configure Interface
...
*   [ch1st/WebScanner](https://github.com/ch1st/WebScanner) - 目录扫描工具 Linux/mac
...
*   [Xchuanshuo/TBS](https://github.com/Xchuanshuo/TBS) - 坦白说QQ优化算法完全解密 加载QQ头像 点击后直接跳转到QQ资料卡页面 也是MVP模式的实例

*   [vv4304/2017718](https://github.com/vv4304/2017718) - android原生APP 在线影视播放类
...
*   [CodFrm/fts](https://github.com/CodFrm/fts) - 文件传输
...
*   [wulijun/php-ext-trie-filter](https://github.com/wulijun/php-ext-trie-filter) - php extension for spam word filter based on Double-Array Trie tree, it can detect if a spam word exists in a text message. 关键词过滤扩展，用于检查一段文本中是否出现敏感词，基于Double-Array Trie 树实现。
...
*   [vv4304/stuShare-android](https://github.com/vv4304/stuShare-android) - 校园网登录app
